# Hugo Natrium, modified for manessinger.com
...
manessinger_com adds comment handling from separate JSON files stored under /comments,
plus a few layout changes, for instance Newer/Older links on single pages.
